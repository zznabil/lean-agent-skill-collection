...
- Default eligible prose is guided by **ASD-STE100** for technical clarity, **ISO 24495-1** plain-language principles for find–understand–use, and **W3C COGA** guidance for cognitive readability. Add the **Feynman method** for difficult explanations, **Diátaxis** for substantial documentation, and **BCP 14** only when normative precision is needed.
