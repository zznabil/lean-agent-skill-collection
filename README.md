...
[![Version](https://img.shields.io/badge/version-v8.3.0-2563eb)](CHANGELOG.md)
...
V8.3.0 keeps the V8 routing surface and adds a human-usable information layer. Substantial instructions, UI text, errors, help, onboarding, and teaching now use explicit user-information, cognitive-accessibility, terminology, and instructional-design sources. Simple replies remain short. Read the [project history](docs/HISTORY.md) and [standards register](docs/STANDARDS-REGISTER.md) for lineage.
...
|---|---:|---|---|
| Core | 8 | Planning, research, review, and long-running work | `lean-agent-skills-core-openai-v8.3.0.zip` |
| Engineering | 19 | Software delivery and engineering operations | `lean-agent-skills-engineering-openai-v8.3.0.zip` |
| Complete | 23 | The full collection | `lean-agent-skills-complete-openai-v8.3.0.zip` |
| Communication | 3 | Clear replies, teaching, writing, and user information | `user-facing-communication-mini-openai-v8.3.0.zip` |
| Get It Done | 3 | Long-horizon execution and acceptance | `get-it-done-pack-openai-v8.3.0.zip` |
| Gauntlet Loop | 1 | High-risk adversarial quality review | `gauntlet-loop-pack-openai-v8.3.0.zip` |
...
docs/                      Catalog, audit, history, standards, and evaluations
...
The source on `main` is canonical after V8.3.0 is merged. Release packages are reproducibly generated from source and include SHA-256 inventories, a manifest, validation records, the license, notices, six profiles, and a master archive. The committed [`dist/v7.2`](dist/v7.2) directory remains a historical V7.2.0 snapshot; binary builds are not accumulated on `main`.
