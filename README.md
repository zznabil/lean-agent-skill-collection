...
[![Version](https://img.shields.io/badge/version-v8.2.0-2563eb)](CHANGELOG.md)
...
V8.2.0 keeps the 23-skill V8 routing surface and makes its standards lineage explicit. User-facing prose now applies ASD-STE100, ISO 24495-1 plain language, and W3C COGA proportionally; Feynman, Diátaxis, and BCP 14 activate only when their purpose applies. Read the [project history](docs/HISTORY.md) and [standards register](docs/STANDARDS-REGISTER.md) for the full lineage.
...
|---|---:|---|---|
| Core | 8 | Planning, research, review, and long-running work | `lean-agent-skills-core-openai-v8.2.0.zip` |
| Engineering | 19 | Software delivery and engineering operations | `lean-agent-skills-engineering-openai-v8.2.0.zip` |
| Complete | 23 | The full collection | `lean-agent-skills-complete-openai-v8.2.0.zip` |
| Communication | 3 | Clear replies, teaching, and writing | `user-facing-communication-mini-openai-v8.2.0.zip` |
| Get It Done | 3 | Long-horizon execution and acceptance | `get-it-done-pack-openai-v8.2.0.zip` |
| Gauntlet Loop | 1 | High-risk adversarial quality review | `gauntlet-loop-pack-openai-v8.2.0.zip` |
...
docs/                      Catalog, audit, history, and standards provenance
...
./scripts/validate.ps1 -ArtifactsDirectory ./artifacts/v8.2.0
```
...
- Static validation is not presented as proof of live routing behaviour or formal conformance.

See the [deep-dive audit](docs/AUDIT.md) for findings, strengths, limitations, and package relationships. [`PACKAGE-VALIDATION.json`](PACKAGE-VALIDATION.json) covers static source and package structure only; it is not a runtime-quality or standards-conformance claim.

## Release integrity

The source on `main` is canonical after the V8.2.0 release is merged. Release packages are reproducibly generated from source and include SHA-256 inventories, a manifest, validation records, the license, notices, six profiles, and a master archive. The committed [`dist/v7.2`](dist/v7.2) directory remains a historical V7.2.0 snapshot; binary builds are not accumulated on `main`.
