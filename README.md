...
[![Release](https://img.shields.io/badge/release-v7.2.1-2563eb)](https://github.com/zznabil/lean-agent-skill-collection/releases/tag/v7.2.1)
...
|---|---:|---|---|
| Core | 9 | Planning, research, review, and long-running work | [ZIP](https://github.com/zznabil/lean-agent-skill-collection/releases/download/v7.2.1/lean-agent-skills-core-openai-v7.2.1.zip) |
| Engineering | 22 | Software delivery and engineering operations | [ZIP](https://github.com/zznabil/lean-agent-skill-collection/releases/download/v7.2.1/lean-agent-skills-engineering-openai-v7.2.1.zip) |
| Complete | 30 | The full collection | [ZIP](https://github.com/zznabil/lean-agent-skill-collection/releases/download/v7.2.1/lean-agent-skills-complete-openai-v7.2.1.zip) |
| Communication | 3 | Clear replies, teaching, and writing | [ZIP](https://github.com/zznabil/lean-agent-skill-collection/releases/download/v7.2.1/user-facing-communication-mini-openai-v7.2.1.zip) |
| Get It Done | 3 | Long-horizon execution and acceptance | [ZIP](https://github.com/zznabil/lean-agent-skill-collection/releases/download/v7.2.1/get-it-done-pack-openai-v7.2.1.zip) |
| Gauntlet Loop | 1 | High-risk adversarial quality review | [ZIP](https://github.com/zznabil/lean-agent-skill-collection/releases/download/v7.2.1/gauntlet-loop-pack-openai-v7.2.1.zip) |
...
GitHub Releases are the canonical download location. Each release includes its SHA-256 inventory, manifest, license, notices, six profile packages, and master archive. The committed [`dist/v7.2`](dist/v7.2) directory is retained as a historical V7.2.0 snapshot; future binary releases are not accumulated on `main`.
