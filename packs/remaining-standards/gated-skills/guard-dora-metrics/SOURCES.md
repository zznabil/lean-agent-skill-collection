# Sources: DORA delivery metrics

Register entry: **76/97**. Historical edition/status: **Current five-metric model**.
Historical decision: **Reject as individual-agent score**.
Historical owner: `Organization delivery analysis only`. Original review date: 2026-08-26.
Original re-review trigger: Material model update.

## What the routine represents
Official DORA five-metric guide; the register's unit-of-assessment restriction remains active.
...
The official DORA metrics guide is linked. This is living systems-level research guidance, not an individual-agent scoring standard or a verified publisher PDF.

## Navigation and verification
Start with the source headings relevant to this task, not the whole reference library. Source focus: Official DORA five-metric guide; the register's unit-of-assessment restriction remains active.
