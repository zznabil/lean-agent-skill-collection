...
Register entry: **71/97**. Historical edition/status: **Current stable**.
Historical decision: **Reject globally**.
Historical owner: `Organization programme only`. Original review date: 2026-08-26.
Original re-review trigger: New major version.

## What the routine represents
Official OWASP SAMM overview; this file implements the register's scope guard, not the full SAMM assessment.
...
SAMM remains rejected as a global agent-work requirement. The current official model is linked; no current complete publisher PDF was verified for redistribution. No legacy PDF is substituted for the current model.

## Navigation and verification
Start with the source headings relevant to this task, not the whole reference library. Source focus: Official OWASP SAMM overview; this file implements the register's scope guard, not the full SAMM assessment.
