# Sources: Safety-critical domain standards

Register entry: **79/97**. Historical edition/status: **Domain-specific**.
Historical decision: **Project-local only**.
Historical owner: `Qualified domain workflow`. Original review date: 2026-08-26.
Original re-review trigger: Project enters regulated domain.

## What the routine represents
Register category and existing Lean qualified-domain boundary; no fabricated universal safety standard.
...
No single canonical source is specified for this domain category. Select the exact project source through its accountable owner.
...
The register names a domain category, not one standard. A qualified project owner must identify the exact applicable and licensed domain sources; no generic official PDF exists for this category.

## Navigation and verification
Start with the source headings relevant to this task, not the whole reference library. Source focus: Register category and existing Lean qualified-domain boundary; no fabricated universal safety standard.
