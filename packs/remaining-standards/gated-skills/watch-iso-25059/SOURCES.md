# Sources: ISO/IEC 25059 AI quality model

Register entry: **72/97**. Historical edition/status: **2023; replacement in development**.
Historical decision: **Watch**.
Historical owner: `docs/STANDARDS-REGISTER.md`. Original review date: 2026-08-26.
Original re-review trigger: Replacement edition final.

## What the routine represents
Historical ISO/IEC 25059:2023 watch entry and official catalogue; no replacement clauses are assumed.
...
**Off-default:** this folder records a restricted, watch, deferred, rejected-generalisation or project-selection decision. Its existence does not activate the underlying framework or overrule the historical decision.

## Source identity / edition observation
The historical watch decision is retained. Source availability or a future replacement does not automatically change adoption status.
...
Start with the source headings relevant to this task, not the whole reference library. Source focus: Historical ISO/IEC 25059:2023 watch entry and official catalogue; no replacement clauses are assumed.
