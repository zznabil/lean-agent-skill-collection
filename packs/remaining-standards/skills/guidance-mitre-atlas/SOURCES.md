...
Register entry: **39/97**. Historical edition/status: **Living knowledge base**.
Historical decision: **Conditional threat source**.
Historical owner: `gauntlet-loop/AI-ASSURANCE.md`. Original review date: 2026-08-26.
Original re-review trigger: Material technique update.

## What the routine represents
MITRE ATLAS official knowledge base and atlas-data project; only selected data/overview is bundled.
...
- https://raw.githubusercontent.com/mitre-atlas/atlas-data/main/README.md
- https://raw.githubusercontent.com/mitre-atlas/atlas-data/main/LICENSE

## Bundled originals
### [ATLAS data repository README](official/atlas-data-README.md)
Publisher/author: MITRE. Edition: Living README; retrieved 2026-09-13.
Format/scope: `official-readme`.
Source URL: https://raw.githubusercontent.com/mitre-atlas/atlas-data/main/README.md
SHA-256: `757dbd6f0eb86159eac808ab56ab63f0e0a88ae485743fcdd2a78e3982620002`
Copying basis: Apache License 2.0; original source and attribution notices retained; no endorsement is implied.
README only, not the complete matrix or data set; use the official knowledge base for technique IDs.

### [ATLAS data licence notice](official/MITRE-NOTICE.txt)
Publisher/author: MITRE. Edition: 2021–2026.
Format/scope: `licence`.
Source URL: https://raw.githubusercontent.com/mitre-atlas/atlas-data/main/LICENSE
SHA-256: `fa6c92ab3dc75d41413884e8b38cc54cd4e72f4c8f68fc7e77824e48e3047d40`
Copying basis: Apache License 2.0; original source and attribution notices retained; no endorsement is implied.
...
Start with the source headings relevant to this task, not the whole reference library. Source focus: MITRE ATLAS official knowledge base and atlas-data project; only selected data/overview is bundled.
