...
Register entry: **10/97**. Historical edition/status: **Living practice**.
Historical decision: **Existing foundation**.
Historical owner: `architecture / project-context`. Original review date: 2026-08-26.
Original re-review trigger: Material practice update.

## What the routine represents
ADR organisation definitions and practices; this is a practice, not a formal numbered standard.
...
No publisher-issued ADR standard PDF was located. The official ADR community site and the project decision-record practice remain linked.

## Navigation and verification
Start with the source headings relevant to this task, not the whole reference library. Source focus: ADR organisation definitions and practices; this is a practice, not a formal numbered standard.
