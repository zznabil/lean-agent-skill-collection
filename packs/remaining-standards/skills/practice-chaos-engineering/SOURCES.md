# Sources: Principles of Chaos Engineering

Register entry: **62/97**. Historical edition/status: **Living principles**.
Historical decision: **Project-local reliability technique**.
Historical owner: `experiment`. Original review date: 2026-08-26.
Original re-review trigger: Material practice update.

## What the routine represents
Principles of Chaos Engineering: steady-state hypothesis, real-world events, control comparison and blast-radius minimisation.
...
The original Principles of Chaos Engineering page is linked. No publisher-issued complete PDF was located; no unofficial PDF conversion is included.

## Navigation and verification
Start with the source headings relevant to this task, not the whole reference library. Source focus: Principles of Chaos Engineering: steady-state hypothesis, real-world events, control comparison and blast-radius minimisation.
