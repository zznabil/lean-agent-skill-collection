...
Register entry: **17/97**. Historical edition/status: **Living requirements method**.
Historical decision: **Adopt syntax**.
Historical owner: `plan / grilling`. Original review date: 2026-08-26.
Original re-review trigger: Material method revision.

## What the routine represents
EARS author: temporal order and ubiquitous, event, state, optional, unwanted and combined patterns.
...
The original author's EARS guidance is linked. No redistributable, publisher-issued complete method PDF was established; no unofficial cheat sheet is labelled official.

## Navigation and verification
Start with the source headings relevant to this task, not the whole reference library. Source focus: EARS author: temporal order and ubiquitous, event, state, optional, unwanted and combined patterns.
