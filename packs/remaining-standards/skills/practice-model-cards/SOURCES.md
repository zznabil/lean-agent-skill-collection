...
Register entry: **43/97**. Historical edition/status: **Established research practice**.
Historical decision: **Adopt template**.
...
Mitchell et al., Model Cards for Model Reporting, 2019; original author paper linked, not republished.
...
The original Model Cards paper is linked. The retrieved author PDF carries ACM personal/classroom copying terms, and the arXiv record uses its non-exclusive distribution licence; broader redistribution permission was not established.

## Navigation and verification
Start with the source headings relevant to this task, not the whole reference library. Source focus: Mitchell et al., Model Cards for Model Reporting, 2019; original author paper linked, not republished.
