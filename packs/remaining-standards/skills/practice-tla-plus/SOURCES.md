...
Register entry: **61/97**. Historical edition/status: **Living language and tools**.
Historical decision: **Project-local escalation**.
Historical owner: `test / architecture`. Original review date: 2026-08-26.
Original re-review trigger: Material tool/spec update.

## What the routine represents
Leslie Lamport's official TLA+ resources; tools and selected tutorials remain external dependencies.
...
The language author's TLA+ resources are linked. A language/tool ecosystem is not one standard PDF; no complete redistributable publisher PDF was established for this selection.

## Navigation and verification
Start with the source headings relevant to this task, not the whole reference library. Source focus: Leslie Lamport's official TLA+ resources; tools and selected tutorials remain external dependencies.
