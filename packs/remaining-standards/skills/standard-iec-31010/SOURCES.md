# Sources: IEC 31010 risk assessment techniques

Register entry: **50/97**. Historical edition/status: **2019**.
Historical decision: **Project-local reference**.
Historical owner: `plan / review`. Original review date: 2026-08-26.
Original re-review trigger: New edition.

## What the routine represents
Public scope: IEC 31010:2019 selection and application of risk-assessment techniques. Lean: plan/review.
...
Start with the source headings relevant to this task, not the whole reference library. Source focus: Public scope: IEC 31010:2019 selection and application of risk-assessment techniques. Lean: plan/review.
