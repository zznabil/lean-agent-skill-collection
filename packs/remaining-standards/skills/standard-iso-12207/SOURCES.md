...
Register entry: **6/97**. Historical edition/status: **2026**.
Historical decision: **Existing foundation**.
Historical owner: `ENGINEERING-CORE / get-it-done`. Original review date: 2026-08-26.
Original re-review trigger: New edition.

## What the routine represents
Public scope: ISO/IEC/IEEE 12207:2026 lifecycle processes. Lean: release and get-it-done.
...
The selected source identity is the register's ISO/IEC/IEEE 12207:2026. No full text was obtained, and no clause number was invented.
...
Start with the source headings relevant to this task, not the whole reference library. Source focus: Public scope: ISO/IEC/IEEE 12207:2026 lifecycle processes. Lean: release and get-it-done.
