# Sources: ISO/IEC/IEEE 15026-2 assurance cases

Register entry: **18/97**. Historical edition/status: **Current edition**.
...
Public scope: assurance-case structure. Lean: review, gauntlet-loop and ENGINEERING-CORE.
...
Start with the source headings relevant to this task, not the whole reference library. Source focus: Public scope: assurance-case structure. Lean: review, gauntlet-loop and ENGINEERING-CORE.
