# Sources: ISO/IEC 20741 tool evaluation

Register entry: **65/97**. Historical edition/status: **2017**.
Historical decision: **Absorb one rule**.
Historical owner: `skill-design`. Original review date: 2026-08-26.
Original re-review trigger: New edition.

## What the routine represents
Public scope: ISO/IEC 20741:2017 software engineering tool evaluation. Lean: skill-design.
...
- https://www.iso.org/standard/68955.html
...
Start with the source headings relevant to this task, not the whole reference library. Source focus: Public scope: ISO/IEC 20741:2017 software engineering tool evaluation. Lean: skill-design.
