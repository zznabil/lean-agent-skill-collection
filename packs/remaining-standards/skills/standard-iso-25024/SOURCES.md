# Sources: ISO/IEC 25024 data quality measures

Register entry: **42/97**. Historical edition/status: **2015**.
Historical decision: **Absorb**.
Historical owner: `project-context/AI-ASSET-CARDS.md / review`. Original review date: 2026-08-26.
Original re-review trigger: New edition.

## What the routine represents
Public scope: ISO/IEC 25024:2015 measurement of data quality. Lean: proof-integrity and data cards.
...
Start with the source headings relevant to this task, not the whole reference library. Source focus: Public scope: ISO/IEC 25024:2015 measurement of data quality. Lean: proof-integrity and data cards.
