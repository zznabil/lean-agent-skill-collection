# Sources: ISO/IEC/IEEE 29148

Register entry: **3/97**. Historical edition/status: **2018**.
Historical decision: **Existing foundation**.
Historical owner: `ENGINEERING-CORE / plan`. Original review date: 2026-08-26.
Original re-review trigger: New edition.

## What the routine represents
Public scope: requirements engineering processes and information items. Lean sources: plan and grilling.
...
Start with the source headings relevant to this task, not the whole reference library. Source focus: Public scope: requirements engineering processes and information items. Lean sources: plan and grilling.
