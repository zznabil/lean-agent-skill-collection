# Sources: ISO/IEC 42005 AI impact assessment

Register entry: **74/97**. Historical edition/status: **2025**.
Historical decision: **Conditional benchmark**.
Historical owner: `project-context/AI-ASSET-CARDS.md`. Original review date: 2026-08-26.
Original re-review trigger: New edition.

## What the routine represents
ISO/IEC 42005:2025 public impact-assessment scope; full text unavailable and historical ISO URL retrieval unresolved. The official page was retrieved at https://www.iso.org/standard/42005 (without .html).
...
**Source-gated ISO/IEC/IEEE entry:** only the public scope and existing Lean practice were available. No licensed full standard, dictionary, paid preview or reconstructed clause library is redistributed. An authorised copy and appropriate use permission are required for formal clause-level work.

## Source identity / edition observation
The official ISO/IEC 42005:2025 page was retrieved at /standard/42005 without .html; the recorded .html address was not retrievable by the download path. Do not substitute ISO/IEC 42001.

## Official source access
- https://www.iso.org/standard/42005.html
...
The full standard is licensed and was not obtained. No authorised redistributable full PDF was established; only official access links are supplied.

## Navigation and verification
Start with the source headings relevant to this task, not the whole reference library. Source focus: ISO/IEC 42005:2025 public impact-assessment scope; full text unavailable and historical ISO URL retrieval unresolved. The official page was retrieved at https://www.iso.org/standard/42005 (without .html).
