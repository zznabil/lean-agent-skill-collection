# Sources: ISO/IEC/IEEE 42010 architecture descriptions

Register entry: **47/97**. Historical edition/status: **Current edition**.
Historical decision: **Absorb**.
Historical owner: `architecture / review`. Original review date: 2026-08-26.
Original re-review trigger: New edition.

## What the routine represents
Public scope: ISO/IEC/IEEE 42010:2022 architecture descriptions. Lean: architecture.
...
Start with the source headings relevant to this task, not the whole reference library. Source focus: Public scope: ISO/IEC/IEEE 42010:2022 architecture descriptions. Lean: architecture.
