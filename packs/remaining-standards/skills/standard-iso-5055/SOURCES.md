# Sources: ISO/IEC 5055 source-code quality measures

Register entry: **64/97**. Historical edition/status: **2021**.
Historical decision: **Project-local benchmark**.
Historical owner: `review / experiment`. Original review date: 2026-08-26.
Original re-review trigger: New edition.

## What the routine represents
Public scope: ISO/IEC 5055:2021 automated source-code quality measures. Lean: review/experiment.
...
Start with the source headings relevant to this task, not the whole reference library. Source focus: Public scope: ISO/IEC 5055:2021 automated source-code quality measures. Lean: review/experiment.
