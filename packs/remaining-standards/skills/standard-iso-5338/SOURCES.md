# Sources: ISO/IEC 5338 AI lifecycle

Register entry: **73/97**. Historical edition/status: **2023**.
Historical decision: **Conditional benchmark**.
Historical owner: `project-context / gauntlet-loop`. Original review date: 2026-08-26.
Original re-review trigger: New edition.

## What the routine represents
Public scope: ISO/IEC 5338:2023 AI system lifecycle processes. Lean: AI assurance and asset cards.
...
Start with the source headings relevant to this task, not the whole reference library. Source focus: Public scope: ISO/IEC 5338:2023 AI system lifecycle processes. Lean: AI assurance and asset cards.
