# Sources: NIST SP 800-61r3 incident response

Register entry: **56/97**. Historical edition/status: **Final**.
Historical decision: **No major change; lineage**.
Historical owner: `triage/INCIDENT.md`. Original review date: 2026-08-26.
Original re-review trigger: New revision.

## What the routine represents
NIST SP 800-61r3, April 2025: CSF 2.0 Community Profile and lifecycle integration.
...
## Bundled originals
### [Incident Response Recommendations and Considerations for Cybersecurity Risk Management](official/nist-incident-800-61r3.pdf)
Publisher/author: National Institute of Standards and Technology. Edition: NIST SP 800-61r3; April 2025.
Format/scope: `official-pdf`; 48 pages.
Source URL: https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-61r3.pdf
SHA-256: `e5593d6bb85daecec7e8d9549400c7b3473bcc3f06e469c82218073afa7fba2d`
...
Start with the source headings relevant to this task, not the whole reference library. Source focus: NIST SP 800-61r3, April 2025: CSF 2.0 Community Profile and lifecycle integration.
