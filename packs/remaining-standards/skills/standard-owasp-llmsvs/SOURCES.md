# Sources: OWASP LLMSVS

Register entry: **16/97**. Historical edition/status: **2.0**.
Historical decision: **Existing conditional benchmark**.
...
Official LLMSVS 2.0 full HTML; the compact routine is not a replacement for its complete requirement set.
...
- https://owasp.github.io/www-project-llm-verification-standard/LLMSVS-v2.0-en.html

## Bundled originals
### [Large Language Model Security Verification Standard](official/llmsvs-2.0.html.txt)
Publisher/author: OWASP LLMSVS project. Edition: 2.0.
Format/scope: `official-html`.
Source URL: https://owasp.github.io/www-project-llm-verification-standard/LLMSVS-v2.0-en.html
SHA-256: `c40e91695354d7b3dbd3675b97381f94e829f025772fbb0c202b967e8cae5193`
...
Start with the source headings relevant to this task, not the whole reference library. Source focus: Official LLMSVS 2.0 full HTML; the compact routine is not a replacement for its complete requirement set.
