# Sources: Software Carbon Intensity / ISO/IEC 21031

Register entry: **69/97**. Historical edition/status: **2024**.
Historical decision: **Project-local only**.
Historical owner: `experiment / architecture`. Original review date: 2026-08-26.
Original re-review trigger: New edition.

## What the routine represents
Open GSF SCI specification v1.1.0 and its licence; ISO/IEC 21031:2024 full text is not supplied.
...
- https://github.com/Green-Software-Foundation/sci/blob/main/LICENCE.md
...
The official GSF SCI method is linked, not copied. Its repository licence reserves non-code material; its MIT grant is for code. The ISO/IEC 21031 publication is a separate licensed source and is not bundled.

## Navigation and verification
Start with the source headings relevant to this task, not the whole reference library. Source focus: Open GSF SCI specification v1.1.0 and its licence; ISO/IEC 21031:2024 full text is not supplied.
