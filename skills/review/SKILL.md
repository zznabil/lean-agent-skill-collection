...
Use an **ISO/IEC 20246-inspired structured review** of the real work product. Select applicable **ISO/IEC 25010** quality attributes, and use an **ISO/IEC/IEEE 15026-2-inspired assurance case** for consequential claims. Apply Google code-review practice: protect correctness and code health without blocking net improvement for hypothetical perfection.
...
7. Check both directions: every acceptance claim maps to evidence, and every material requirement or changed public behavior appears in the verdict or is explicitly excluded. For a consequential multi-evidence claim, summarize claim, scope, argument, evidence, defeaters, and status.
